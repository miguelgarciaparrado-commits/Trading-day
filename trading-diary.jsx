  ...
  function sendAlert(label,interval,rsi,type,e1,e2,customDesc,price,extra){
    ...
    if(tk&&cid){
      ...
      if(isDivType&&extra.divVolMult!==null&&extra.divVolMult!==undefined){
        tgLines.push("📊 Vol. vela: "+extra.divVolMult+"× MA20 "+(extra.divVolOk?"✅":"⚠️ bajo volumen — confirmar en gráfico"));
      }
      ...
      if(type==="patron_fvg"&&extra.fvgResult){
        ...
        tgLines.push("   Rango FVG: $"+parseFloat(fvgR.bot).toLocaleString("es-ES",{maximumFractionDigits:2})+" – $"+parseFloat(fvgR.top).toLocaleString("es-ES",{maximumFractionDigits:2}));
        ...
        if(extra.fvgVolMult!==null&&extra.fvgVolMult!==undefined){
          tgLines.push("   📊 Volumen: "+extra.fvgVolMult+"× MA20 "+(extra.fvgVolOk?"✅":"⚠️ volumen alto — posible capitulación"));
        }
      }
    ...
    function processStockCandles(d,isLive){
      ...
      if(divResultFH){
        ...
        if(!zoneSuppFH&&Date.now()-prevDivFiredFH>divCooldownFH){
          ...
          sendAlert(alert.label,alert.interval,rsi,divAlertFH,ema7,ema25,null,closePrice,{ohlc:ohlc,divResult:divResultFH,divVolMult:fhVolMult,divVolOk:fhVolMult!==null&&fhVolMult>=1.2});
        }
      ...
      .then(function(data){
        ...
        ws.onmessage=function(e){
            ...
            if(alert.rsiDivEnabled!==false){
              if(divResult){
                ...
                if(!zoneSuppressed&&Date.now()-prevDivFired>divCooldownMs){
                  ...
                  sendAlert(alert.label,alert.interval,rsi,divAlertType,ema7,ema25,null,closePrice,{ohlc:ohlc,volDir:volDir,divResult:divResult,ema50:ema50,ema200:ema200,divVolMult:wsVolMult,divVolOk:wsVolMult!==null&&wsVolMult>=1.2});
                }
            }
          }
          ...
          if(k.x){
            ...
            // FVG — con filtro de alineación HTF y volumen
            ...
            if(fvgResult){
              ...
              // Filtro de volumen: evitar entrar en capitulación
              ...
              if(alert.fvgEnabled!==false&&!lastTrigRef.current[ak+"fvg"]){
                ...
                sendAlert(alert.label,alert.interval,rsi,"patron_fvg",ema7,ema25,null,closePrice,{ohlc:ohlc,divResult:divResult,fvgResult:fvgResult,fvgHtfAligned:fvgHtfAligned,fvgHtfLabel:fvgHtfLabel,fvgHigherTF:fvgHigherTF,fvgVolMult:fvgVolMult,fvgVolOk:fvgVolOk});
              }
