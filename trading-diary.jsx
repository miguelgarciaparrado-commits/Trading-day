...
function AlertasTab({S,predictions}){
  ...
  function sendAlert(label,interval,rsi,type,e1,e2,customDesc,price,extra){
    ...
    if(tk&&cid){
      ...
      var BULLISH_TYPES=["rsi_oversold","golden","ema200_golden","rsi_div_bull","rsi_conv_bull","patron_fvg","canal_bajista_ruptura_alcista","canal_alcista_ruptura_alcista","canal_bajista_retest_bull","canal_alcista_retest_bull"];
      var BEARISH_TYPES=["rsi_overbought","death","ema200_death","rsi_div_bear","rsi_conv_bear","canal_alcista_ruptura_bajista","canal_bajista_ruptura_bajista","canal_alcista_retest_bear","canal_bajista_retest_bear"];
                ...
                if(retDone||Date.now()-confTs>retWindow){
                  ...
                  if(deepInvalid){
                    ...
                    if(nearBrkLine){
                      ...
                      // Rejection: candle closes away from broken line in expected direction
                      var rejBull=retIsBull&&lastCdl.c>confBrkLine&&lastCdl.c>lastCdl.o;
                      var rejBear=(!retIsBull)&&lastCdl.c<confBrkLine&&lastCdl.c<lastCdl.o;
                      ...
                      if(rejBull||rejBear){
                        ...
                        var retestPayload={retestEntry:true,retestBull:retIsBull,retestDir:confBrkDir,retestLine:confBrkLine,entry:retEntry,sl:retSl,tp1:retTp1,rr1:retRR1,rrOk:retRRok,invalidation:retInval,volOk:retVolOk,volMult:retVolMult,candleDesc:retIsBull?"Vela alcista en soporte dinámico":"Vela bajista en resistencia dinámica"};
